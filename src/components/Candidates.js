        ...
        <div className="dashbord-part-2">
          ...
          <div className="employeeBlock">
            ...
            <div className="employeeBlockNameEmail">
              <h2>Name of the Candidate</h2>
              <p>Email_of_the_candidate</p>
              <p>Phone_number</p>
            </div>

            <div className="employeeBlockLine"></div>
            <div className="employeeBlockEditDelete">
              <button className="employeeBlockEdit">Schedule Interview</button>
              <button className="employeeBlockDelete">Reject</button>
            </div>
          </div>
          <div className="employeeBlock">
            <svg
