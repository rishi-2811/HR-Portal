  ...
  return (
    <>
      <div className="container">
        ...
        <div key={candidate._id} className="employeeBlock">
          ...
          <div className="employeeBlockLine"></div>
          <div className="employeeBlockEditDelete">
            <button className="employeeBlockEdit" onClick={() => onAccept(candidate.id)}>Schedule Interview</button>
            <button className="employeeBlockDelete" onClick={()=>onReject(candidate.id)}>Reject</button>
          </div>
        </div>
      ))}
        </div>
